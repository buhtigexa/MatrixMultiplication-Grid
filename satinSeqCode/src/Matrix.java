...
/**
 * 
 * Satin impone una restriccion sobre el tipo de retorno y parametro para los jobs, estos deben ser tipos primitivos o 
 *  implementar java.io.Serializable; para implementar la version secuencial, podemos eliminar las sentencias correspondientes.
 *  
 *
 */
final class Matrix extends Leaf implements java.io.Serializable {
    ...
    /**
     * 
     *  El argumento task no es util para la version secuencial, por lo tanto lo 
     *  eliminamos, tambien borramos las sentencias relacionadas.
     * 
     */  
