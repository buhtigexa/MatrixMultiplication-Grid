...
/**
 * 
 *  Satin impone una restriccion sobre el tipo de retorno y parametros para los jobs, estos deben ser tipos primitivos o en su defecto, 
 *  implementar java.io.Serializable; para obtener la version secuencial eliminar las sentencias correspondientes.
 *   
 *
 */
class Leaf /*implements java.io.Serializable*/ {
   ...
   /**
    * 
    *  Eliminamos el argumento task, ya no es necesario pues no hay gridificacion.
    */
